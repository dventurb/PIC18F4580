# 1 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c" 2


# 1 "/opt/microchip/xc8/v3.00/pic/include/c99/ctype.h" 1 3
...
# 9 "/opt/microchip/xc8/v3.00/pic/include/c99/ctype.h" 2 3
...
int tolower(int);
int toupper(int);
# 4 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c" 2
# 1 "/opt/microchip/xc8/v3.00/pic/include/c99/math.h" 1 3



# 1 "/opt/microchip/xc8/v3.00/pic/include/c99/musl_xc8.h" 1 3
# 5 "/opt/microchip/xc8/v3.00/pic/include/c99/math.h" 2 3
...
# 11 "/opt/microchip/xc8/v3.00/pic/include/c99/math.h" 2 3




# 1 "/opt/microchip/xc8/v3.00/pic/include/c99/bits/alltypes.h" 1 3
# 39 "/opt/microchip/xc8/v3.00/pic/include/c99/bits/alltypes.h" 3
...
# 16 "/opt/microchip/xc8/v3.00/pic/include/c99/math.h" 2 3
# 42 "/opt/microchip/xc8/v3.00/pic/include/c99/math.h" 3
...
# 59 "/opt/microchip/xc8/v3.00/pic/include/c99/math.h" 3
double acos(double);
float acosf(float);
...
# 326 "/opt/microchip/xc8/v3.00/pic/include/c99/math.h" 3
...
# 431 "/opt/microchip/xc8/v3.00/pic/include/c99/math.h" 3
extern int signgam;
...
# 5 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c" 2
# 1 "/opt/microchip/xc8/v3.00/pic/include/c99/stdarg.h" 1 3
...
# 9 "/opt/microchip/xc8/v3.00/pic/include/c99/stdarg.h" 2 3
...
# 6 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c" 2
...
# 7 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c" 2

# 1 "/opt/microchip/xc8/v3.00/pic/include/c99/stdio.h" 1 3
# 24 "/opt/microchip/xc8/v3.00/pic/include/c99/stdio.h" 3
# 1 "/opt/microchip/xc8/v3.00/pic/include/c99/bits/alltypes.h" 1 3
# 17 "/opt/microchip/xc8/v3.00/pic/include/c99/bits/alltypes.h" 3
...
# 9 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c" 2
...
# 10 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c" 2
...
# 11 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c" 2
# 1 "/opt/microchip/xc8/v3.00/pic/include/c99/inline.h" 1 3
# 12 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c" 2
# 1 "/opt/microchip/xc8/v3.00/pic/include/c99/stdbool.h" 1 3
# 13 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c" 2
# 97 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
...
# 185 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
static char dbuf[32];
...
{
    int i;
# 205 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
 if (p < 0) {
  p = 0;
 }
    i = 0;
...
# 1176 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
static void
...
# 1201 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    if ((*fmt)[0] == '%') {
        ++*fmt;

        flags = width = 0;
        prec = -1;
# 1291 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
  cp = *fmt;
# 1361 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
  if (*cp == 'd' || *cp == 'i') {
# 1404 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
...
# 1806 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
        ++*fmt;
        return (void) 0;
    }
